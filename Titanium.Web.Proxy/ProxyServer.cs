...
namespace Titanium.Web.Proxy
{
    ...
    public partial class ProxyServer : IDisposable
    {
        ...
        {
            get { return exceptionFunc ?? defaultExceptionFunc; }
            set
            {
                exceptionFunc = value;
        ...
        {
#if DEBUG
            if (clientStream is DebugCustomBufferedStream)
            {
                DebugCustomBufferedStream debugStream = clientStream as DebugCustomBufferedStream;
